...
const Tab = createBottomTabNavigator<MainTabParamList & { Gamification: undefined }>();
...
export const MainNavigator: React.FC = () => (
  <Tab.Navigator
    ...
    <Tab.Screen name="Gamification" component={GamificationNavigator}
      options={{ tabBarIcon: icon('🏆'), tabBarLabel: 'Ranks',
        headerShown: true, headerTitle: 'Gamification',
        headerStyle: { backgroundColor: colors.primary }, headerTintColor: '#fff' }} />
